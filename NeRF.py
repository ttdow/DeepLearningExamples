...
def train(nerf_model, optimizer, scheduler, data_loader, device='cpu', hn=0, hf=1, nb_epochs=int(1e5), nb_bins=192, H=400, W=400):
    ...
    for _ in tqdm(range(nb_epochs)):
        ...
        for img_index in range(200):
            test(nerf_model, hn, hf, testing_dataset, img_index=img_index, nb_bins=nb_bins, H=H, W=W)
...
train(model, model_optimizer, scheduler, data_loader, nb_epochs=1, device=device, hn=2, hf=6, nb_bins=192, H=400, W=400)